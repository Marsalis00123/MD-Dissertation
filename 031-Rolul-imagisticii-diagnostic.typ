#pagebreak()
= Contribuția imagisticii în managementul spondilodiscitei
...
Radiografiile simple sunt larg accesibile și relativ ieftine în comparație cu alte metode imagistice avansate, cum ar fi RM-ul sau CT-ul. Acestea sunt disponibile în majoritatea instituțiilor medicale, inclusiv în zonele cu resurse limitate, ceea ce le face o opțiune practică pentru evaluarea inițială a pacienților. Costul redus și accesibilitatea ridicată le permit să fie utilizate pe scară largă, inclusiv pentru monitorizarea pe termen lung a pacienților
@ImagingSpondylodiscitisComprehensive2024.
...
În diagnosticul spondilodiscitei, rezonanța magnetică (RM) rămâne standardul de aur datorită sensibilității și specificității sale ridicate. RM-ul cu contrast demonstrează o sensibilitate de 97%, o specificitate de 93% și o acuratețe de 94% în diagnosticarea spondilodiscitei @ComparisonDiagnosticValue2017. Aceste valori sunt considerabil mai ridicate în comparație cu alte modalități imagistice, ceea ce evidențiază superioritatea RM-ului nu doar în detectarea infecțiilor vertebrale, ci și în facilitarea descrierii detaliate a acestora de către medicul radiolog.
