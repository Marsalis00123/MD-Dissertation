...
Manifestări la 3-6 săptămâni de la infecție:

- fragmentarea sau eroziunea unghiului anterior al plăcii vertebrale,
- reducerea spațiului intervertebral,
- pierderea lordozei fiziologice și deformarea structurală.

Manifestările târzii după 8-12 săptămâni includ:

- scleroza reactivă și formarea de punți osoase între vertebre.

Cu toate acestea, o radiografie cu aspect normal nu poate exclude o spondilodiscită@SpondylodiscitisDiagnosisTreatment2017.

Radiografiile simple au o sensibilitate și specificitate redusă în diagnosticul spondilodiscitelor, în special în stadiile incipiente ale infecției @SuggestionsManagingPyogenic2007 @SpinalInfections2005 @ImagingSpondylodiscitisComprehensive2024. Această metodă diagnostică necesită o reducere de 30% până la 40% a matricei osoase pentru a evidenția pierderea osoasă, ceea ce poate întârzia identificarea precoce a patologiei. Pot detecta semne evidente ale bolii după 8-12 săptămâni, precum eroziunea platourilor vertebrale și reducerea spațiului intervertebral, dar sunt limitate în identificarea modificărilor subtile. De exemplu, în tuberculoza spinală, radiografiile arată o sensibilitate de 82% și o specificitate de 57% @SpinalInfectionsClinical2014, ceea ce înseamnă că există un risc semnificativ de rezultate fals negative sau fals pozitive. 

Radiografiile simple sunt larg accesibile și relativ ieftine în comparație cu alte metode imagistice avansate, cum ar fi RMN-ul sau CT-ul. Acestea sunt disponibile în majoritatea instituțiilor medicale, inclusiv în zonele cu resurse limitate, ceea ce le face o opțiune practică pentru evaluarea inițială a pacienților. Costul redus și accesibilitatea ridicată le permit să fie utilizate pe scară largă, inclusiv pentru monitorizarea pe termen lung a pacienților. Totuși, limitările lor în detectarea precoce și în diferențierea precisă a patologiilor infecțioase de cele degenerative pot necesita utilizarea unor investigații suplimentare mai costisitoare pentru confirmarea diagnosticului. 
...
- identificarea, caracterizarea și cuantificarea extinderii proceselor osteolitice,
...
În diagnosticul spondilodiscitei, rezonanța magnetică (RMN) rămâne metoda preferată datorită sensibilității și specificității sale ridicate. RMN-ul contrast-enhanced are o sensibilitate de 97%, specificitate de 93% și o acuratețe de 94% în diagnosticarea spondilodiscitei @ComparisonDiagnosticValue2017 . Această tehnică este excelentă pentru a dezvălui extinderea infecției, oferind imagini superioare ale țesuturilor moi paraspinale și spațiului epidural. Totuși, rezultatele pot fi normale în primele 2-4 zile de la debutul simptomelor.

Secvențele RMN recomandate includ imagistica ponderată T2 cu suprimarea grăsimii și imagistica ponderată T1 post-gadoliniu cu suprimarea grăsimii @ComparisonDiagnosticValue2017 Alternativ, pot fi utilizate secvențele DIXON T2-WI și T1-WI contrast-enhanced (CE) cu imaginile Fat, Water, și In-phase. De asemenea, imagistica ponderată prin difuzie (DWI) este utilă în cazurile în care pacienții nu pot efectua RMN contrast-enhanced din cauza contraindicațiilor, cum ar fi reacțiile alergice sau insuficiența renală. DWI poate ajuta la detectarea abceselor și la diferențierea infecției de modificările degenerative, deși sensibilitatea sa în diferențierea între spondilodiscită și alte diagnostice diferențiale este moderată.

Spondilodiscita provoacă exudat inflamator care înlocuiește măduva osoasă normală cu celule albe și cauzează hiperemie, rezultând în modificări ale semnalelor RMN, manifestându-se ca intensitate hipo- sau izointensă pe T1 și hiperintensă pe T2 la nivelul plăcilor subcondrale și discului intervertebral @DiagnosticPerformanceMultiDetector2022. Modificările semnalului încep de obicei în partea anterioară a corpului vertebral, afectând unul sau mai multe segmente ale coloanei vertebrale și pot fi unilaterale în stadiile incipiente ale bolii. Eroziunile osoase ale plăcilor terminale sunt de asemenea observate. Contrastul plăcii vertebrale poate prezenta diverse modele, precum difuze, petice, aglomerate sau liniar paralele cu placa terminală, ceea ce duce la pierderea definiției plăcii terminale și la reducerea înălțimii discului.
